  ...
  return (
    <aside
      className={`
        ...
        bg-slate-50 dark:bg-slate-900 border-r border-border flex flex-col
      ...
      <div className={`border-t border-border space-y-1 ${sidebarCollapsed ? 'p-2' : 'p-4'}`}>
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent side="right" align="end" className="w-56">
            ...
            {/* Polices */}
            <DropdownMenuItem
              onClick={() => openTab({ type: 'settings', path: '/settings/fonts', title: 'Polices' }, true)}
            >
              <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            {/* Styles Chat */}
            <DropdownMenuItem
              onClick={() => openTab({ type: 'settings', path: '/settings/chat-styles', title: 'Styles Chat' }, true)}
            >
              <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
