...
export function ProposalTemplatesTab() {
  ...
  const handleCreateFromBlank = () => {
    // Open new proposal wizard - the user can then save as template
    openTab({
      type: 'new-proposal',
      path: '/proposals/new',
      title: 'Nouvelle Proposition',
    }, true);
    toast.info('Creez votre proposition puis cliquez "Template" pour l\'enregistrer comme template');
  };
        ...
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-4">
            <button
              onClick={() => openTab({
                type: 'documents',
                path: '/documents?tab=proposals',
                title: 'Documents',
              }, true)}
              className="p-2 text-gray-400 hover:text-gray-600 hover:bg-gray-100 rounded-lg transition-colors"
              title="Retour aux propositions"
            >
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-900">Templates de propositions</h1>
              <p className="text-sm text-gray-500 mt-1">
                Creez une proposition vide puis enregistrez-la comme template.
              </p>
            </div>
          </div>
          <Button onClick={handleCreateFromBlank}>
          ...
          <div className="flex gap-3">
            ...
            <div className="text-sm text-blue-800">
              ...
              <ol className="list-decimal list-inside space-y-1 text-blue-700">
                <li>Cliquez &quot;Nouvelle proposition&quot; pour creer une proposition vide</li>
                <li>Editez le contenu de votre proposition</li>
                <li>Cliquez le bouton &quot;Template&quot; dans l&apos;editeur pour l&apos;enregistrer comme template</li>
              </ol>
            </div>
          </div>
        </div>
