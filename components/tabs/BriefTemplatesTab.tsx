...
export function BriefTemplatesTab() {
  ...
  const openTemplateEditor = (template: BriefTemplate) => {
    openTab({
      type: 'edit-brief-template',
        ...
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-4">
            <button
              onClick={() => openTab({
                type: 'documents',
                path: '/documents?tab=briefs',
                title: 'Documents',
              }, true)}
              className="p-2 text-gray-400 hover:text-gray-600 hover:bg-gray-100 rounded-lg transition-colors"
              title="Retour aux briefs"
            >
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-900">Templates de briefs</h1>
