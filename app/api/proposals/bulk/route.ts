...
/**
 * DELETE /api/proposals/bulk
 * Soft delete multiple proposals
 * Body: { ids: string[] }
 */
export async function DELETE(request: Request) {
  try {
    ...
    console.error('DELETE /api/proposals/bulk error:', error);
    return NextResponse.json(
...
export async function PATCH(request: Request) {
  try {
    ...
    console.error('PATCH /api/proposals/bulk error:', error);
    return NextResponse.json(
