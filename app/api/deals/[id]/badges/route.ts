...
import { addDealBadge, removeDealBadge } from '@/lib/deals';

/**
 * POST /api/deals/:id/badges
...
export async function POST(
  ...
  try {
    ...
    const result = await addDealBadge(id, badge, variant);
...
export async function DELETE(
  ...
  try {
    ...
    const result = await removeDealBadge(id, badge);
