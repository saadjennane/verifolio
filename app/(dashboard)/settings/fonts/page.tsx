...
export default function FontsComparisonPage() {
  ...
  return (
    <div className="p-6 max-w-5xl mx-auto">
      {/* Header */}
      <div className="mb-8">
        <h1 className="text-2xl font-bold text-gray-900">Comparaison des polices</h1>
        <p className="text-gray-500 mt-1">
          Prévisualisez et comparez les polices pour votre application
        </p>
      </div>
      ...
      <div className="mb-6 p-4 bg-gray-50 rounded-lg border border-gray-200">
        <p className="text-sm text-gray-600">
          <span className="font-medium">{currentFont.name}:</span> {currentFont.description}
        </p>
      </div>

      {/* Preview Area */}
      <div className={`${currentFont.className} bg-white rounded-xl border border-gray-200 overflow-hidden`}>
        {/* Preview Header */}
        <div className="px-6 py-4 border-b border-gray-100 bg-gray-50">
          <span className="text-sm font-medium text-gray-500">APERÇU EN DIRECT</span>
        </div>

        <div className="p-6 space-y-8">
          {/* Typography Samples */}
          <div className="space-y-4">
            <h1 className="text-3xl font-bold text-gray-900">Titre principal H1</h1>
            <h2 className="text-xl font-semibold text-gray-800">Sous-titre H2 - Gestion des clients</h2>
            <h3 className="text-lg font-medium text-gray-700">Section H3 - Détails du devis</h3>
          ...
          <div className="p-4 bg-gray-50 rounded-lg">
            <h4 className="text-sm font-medium text-gray-500 mb-3">CHIFFRES ET MONTANTS</h4>
          ...
          <div className="border border-gray-200 rounded-lg overflow-hidden">
            <div className="px-4 py-2 bg-gray-50 border-b border-gray-100">
              <span className="text-sm font-medium text-gray-600">Simulation Chat</span>
            </div>
            <div className="p-4 space-y-3 bg-white">
              ...
              <div className="flex gap-2 mt-3 pt-3 border-t border-gray-100">
                ...
                <button className="px-4 py-2 text-sm font-medium bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-lg transition-colors">
                  Non
                </button>
                <button className="px-4 py-2 text-sm font-medium bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-lg transition-colors">
                  Modifier
          ...
          <div className="border border-gray-200 rounded-lg overflow-hidden">
            <table className="w-full text-sm">
              ...
              <tbody className="divide-y divide-gray-100">
                <tr>
                  <td className="px-4 py-3 font-medium text-gray-900">Acme Corp</td>
                  <td className="px-4 py-3 text-gray-600">Entreprise</td>
                  <td className="px-4 py-3 text-right text-gray-900">5 400,00 €</td>
                ...
                <tr>
                  <td className="px-4 py-3 font-medium text-gray-900">Jean Dupont</td>
                  <td className="px-4 py-3 text-gray-600">Particulier</td>
                  <td className="px-4 py-3 text-right text-gray-900">1 250,00 €</td>
                  <td className="px-4 py-3 text-center">
                ...
                <tr>
                  <td className="px-4 py-3 font-medium text-gray-900">Tech Solutions</td>
                  <td className="px-4 py-3 text-gray-600">Entreprise</td>
                  <td className="px-4 py-3 text-right text-gray-900">12 800,00 €</td>
                  <td className="px-4 py-3 text-center">
          ...
          {/* Form Elements */}
          <div className="space-y-4">
            <h4 className="text-sm font-medium text-gray-500">ÉLÉMENTS DE FORMULAIRE</h4>
      ...
      <div className="mt-6 flex justify-end">
        <Button
          ...
          className="px-6"
          onClick={() => {
            // Pour l'instant, juste un log - l'application de la police nécessiterait
            // une modification du layout global
