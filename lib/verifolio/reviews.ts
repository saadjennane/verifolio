...
export async function getPublicReviews(
  ...
  for (const selection of selections) {
    ...
    reviews.push({
      ...
      reviewer_company_logo_url: review.consent_display_identity ? review.reviewer_company_logo_url : null,
      ...
      is_professional_email: review.is_professional_email,
