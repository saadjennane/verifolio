-- Migration 036: Force recreation of deal_is_late function
-- Drop and recreate to ensure the old buggy version is completely removed

DROP FUNCTION IF EXISTS deal_is_late(UUID);
